...
namespace StorageService.Services
{
    public class FileRepository : IFileRepository
    {
        ...
        public async Task<FileState> UploadFileAsync(IFormFile file, User user, bool isPublic)
        {
            if (file is null)
            ...
            await using (var fs = System.IO.File.Create(fileSavePath + "\\" + fileName))
            {
        ...
        public async Task<File> GetFileByRelativePathAsync(string relativePath) =>
            await _context.Files.FirstOrDefaultAsync(file => file.Path.Equals(relativePath));

        public string GetFilePath(string relativePath)
        {
            var splittedPath = relativePath.Split('/');
            return Path.Combine(_filePath, "files", splittedPath[0], splittedPath[1]);
        }
